...
var list = function (modules, opts) {
	opts = opts || {};
...
var summary = function (modules, opts) {
	const o = {};
...
var circular = function (spinner, res, circular, opts) {
	if (opts.json) {
...
var modules = function (modules, opts) {
	if (opts.json) {
		return printJSON(modules);
	}
...
var getResultSummary = function (res, startTime) {
