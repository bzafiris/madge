...
const exec = pify(child_process_moduleObject.exec);
const writeFile = pify(fs_moduleObject.writeFile);
...
var svg = function (modules, circular, config) {
...
var image = function (modules, circular, imagePath, config) {
	const options = createGraphvizOptions(config);
...
var dot = function (modules, circular, config) {
	const options = createGraphvizOptions(config);
